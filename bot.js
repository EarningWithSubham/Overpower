...
var bot_token = '5743063095:AAF5giOE_JgSDfcDwMgFjYgiVSeMPWb6UR8'; //YOUR BOT TOKEN HERE

var bot_name = 'Over_Power_SP_Robot'; // Bot Name
...
const admin_id = 1668436744;

const admin_id2 = 5122646798;

var mongo_url = 'mongodb+srv://Overpower:Overpower@cluster0.ey8uzmw.mongodb.net/?retryWrites=true&w=majority'; // Your Mongo URL Here
...
bot.hears(/^\/start (.+[1-9]$)/, async (ctx) => {
    ...
    try {
        ...
        if (admin.length == 0) {
            ...
            db.collection('admindb').insertOne({ admin: "admin", ref: 0.5, cur: 'INR', paychannel: payout_channel_sp', bonus: 0.1, minimum: 1, botstat: 'Active', withstat: 'ON', subwallet: 'NOT SET', MKEY: 'NOT SET', MID: 'NOT SET', channels: [] })
